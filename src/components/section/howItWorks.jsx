export default function HowItWorks() {
    ...
    return (
        ...
        <>
            ...
            <section className="py-24 2xl:pt-40  bg-white">
                <div className="container mx-auto px-4">
                    <div className="mb-20 2xl:mb-36 text-center">
                        <span className="block mb-9 font-medium uppercase tracking-widest text-xs leading-4 text-gray-300">How it works</span>
                        <h2 className="mb-12 font-heading font-medium text-6xl md:text-10xl xl:text-11xl leading-none">Easy to use</h2>
                    </div>
                            ...
                            <div className="flex flex-wrap md:flex-nowrap items-center xl:items-start -mx-2">
                                <div className="w-full lg:w-1/2 xl:w-1/4 px-2 mb-5 xl:mb-0">
                                    <div className="pt-16 pb-20 px-8 lg:px-12 2xl:px-16 border-black border-opacity-10 border rounded-3xl">
                                        ...
                                        <h2 className="mb-6 xl:mb-14 font-heading font-medium text-6xl xl:text-4xl leading-tight">Discover Simplicity</h2>
                                        <p className="text-lg text-darkBlueGray-400">Explore an intuitive design experience..</p>
                                    </div>
                                </div>
                                <div className="w-full lg:w-1/2 xl:w-2/4 px-2 mb-5 xl:mb-0">
                                    <div className="pt-16 pb-20 px-8 lg:px-12 2xl:px-16 mb-5 border border-black border-opacity-10 rounded-3xl">
                                        ...
                                        <h2 className="mb-6 font-heading font-medium text-6xl lg:text-4xl leading-tight">Effortless Creation</h2>
                                        <p className="text-lg text-darkBlueGray-400">Bring your ideas to life with ease.</p>
                                    </div>
                                    <div className="pt-16 pb-20 px-8 lg:px-12 2xl:px-16 border border-black border-opacity-10 rounded-3xl">
                                        ...
                                        <h2 className="mb-6 font-heading font-medium text-6xl lg:text-4xl leading-tight">Seamless Workflow</h2>
                                        <p className="text-lg text-darkBlueGray-400">Smoothly navigate from concept to completion.</p>
                                    </div>
                                </div>
                                <div className="w-full lg:w-1/2 xl:w-1/4 px-2">
                                    <div className="pt-16 pb-20 px-8 lg:px-12 2xl:px-16 border border-black border-opacity-10 rounded-3xl">
                                        ...
                                        <h2 className="mb-6 xl:mb-14 font-heading font-medium text-6xl 2xl:text-4xl leading-tight">User-Friendly Steps</h2>
                                        <p className="text-lg text-darkBlueGray-400">A straightforward journey to your masterpiecue.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex w-44 h-1 bg-blue-200 mx-auto"><a className="w-1/2 bg-indigo-500" href="#"></a><a className="w-1/2 bg-transparent" href="#"></a></div>
                </div>
            </section>
